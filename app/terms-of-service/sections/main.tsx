      ...
      <div className="container mx-auto px-8 py-14 max-w-3xl">
        <div className="bg-white rounded-2xl shadow-sm p-8 md:p-12 space-y-10">
          ...
          <Section title="10. Contact Us">
            ...
            <ul>
              <li><strong>Email:</strong> <a href="mailto:support@candonkeys.com" className="text-[#1a4f80] font-bold hover:text-[#6ab04c] transition-colors">hello@candonkeys.com</a></li>
              <li><strong>Phone:</strong> <a href="tel:+12672813939" className="text-[#1a4f80] font-bold hover:text-[#6ab04c] transition-colors">(215) 555-0000</a></li>
